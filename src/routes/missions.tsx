...
function MissionsPage() {
  ...
  return <MobileLayout><div className="px-4 pt-6">
    ...
    {active?.type === "breathing" && <BreathingMission cycles={active.id === "deep-breath" ? 8 : 4} onComplete={() => finishMission(active, "Respiración completada")} onClose={() => setActive(null)} />}
    {active?.type === "journal" && <JournalMission onComplete={(_t, mood) => finishMission(active, `Mood: ${mood}`)} onClose={() => setActive(null)} />}
